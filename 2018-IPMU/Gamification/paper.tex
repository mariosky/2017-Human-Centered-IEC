...
But even if adaptation is straightforward, the application of volunteer computing techniques to the development of distributed evolutionary algorithms 
...
computing techniques as a part of a larger distributed computing
...
as a benchmark for evolutionary algorithms % and is represented in
% figure \ref{fig:trap}
...
contained 933,513 contributions both
