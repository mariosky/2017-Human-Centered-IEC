...
\ref{sec:experiments}, to finally wrap up with the conclusions. %Pablo: check out this paragraph! Section 3 is not describing the problem and framework, it is only discussing on related work on gamification! I suggest combine section Gamification into Section 2, and separate Section 4.2 (Results) as a new Section before Conclusions.
...
\section{Experiment} %Pablo: change this to Experimental Setup, as it also describes the system
...
After login, %Pablo: after login where? Add a link to the page or explain that the system was run in our servers
...
available \url{https://github.com/lucero21/login-master}. %Pablo: I suggest to move the link to the introduction, just after the first time it is mentioned as free software
