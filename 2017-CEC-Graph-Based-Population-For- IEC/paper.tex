...
\begin{itemize}
  ...
  as a social network, with well established semantics, algorithms and metrics (cite).
...
\begin{itemize}
  ...
  to be done by devices lent by the human [cite nodio].
  ...
  humans, for instance in the XY project [cite] artists physically created
  the new population.  
\end{itemize}
...
\begin{itemize}
\item Non Gamification. All users have the same weight.
\item Non Graph Gamification. Only experience is considered
\item Graph Gamification. Both experience and participation where considered.
\end{itemize}
