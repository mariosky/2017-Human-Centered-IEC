...
the population, or the interaction as a whole. For instance when creating a new individual 
parents could be selected if there is a minimum distance between them in the graph.
