...
\begin{itemize}
  ...
  population % do you mean different generations? Would be better to
...
individual.  % Still think that user and individual is confusing - JJ
...
individuals for each volunteer is presented in figure
