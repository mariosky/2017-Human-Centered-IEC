...
\title{A graph-based approach for interactive 
...
system.  Thus, the main loop of the EA need a human intervention for
the quality assessment of each proposed solution. These systems have an
inherent drawback araising from the very nature of the model, namely,
the human fatigue caused by the interaction. Some authors have already
tried to address this basic problem \cite{Frade:2010:EvoGAMES}.
...
as well as other domains \cite{ie1}. 
