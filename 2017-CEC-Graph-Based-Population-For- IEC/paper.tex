...
\begin{enumerate}
  ...
  \item Fitness evaluation can also be extracted from different kind of relationships
  between a user and an individual, using common actions? found in social networks,
  for instance share, like, or add to collection.  
