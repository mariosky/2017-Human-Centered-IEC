...
% define better the purpose. Not clear. "giving the same importance to users and their interactions"? - JJ
...
%  2) Then it could be difficult to query with Cypher (I think) - Mario
\end{itemize}
...
% I read graph them :)  but is:  graph then , now I get it. 
...
% Ok, I will mention the types of graphs. -Mario
