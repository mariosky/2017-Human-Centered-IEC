...
\begin{itemize}
  ...
  human users and their interactions with one or more individuals from
  ...
  There is also the posibility that fitness is or part of the search is done
  in devices lended by the human. The information gathered through the 
  interaction will guide the search. 

% We could reference Nod
