...
The experiment will run until November 27th, Thanks!.'' We also included links to register and a deadline. Users visiting the page after the deadline were presented with a thank you message and a final leader board. Considering the number of friends, followers and the organic sharing of the posts, we estimate the post was viewed by around 2000 users. Relatively small samples of users ($10\pm$) are sufficient for discovering 80\% of usability problems \cite{Schmettow2012}.
% The previous sentence has to be preceded by another saying something like
% We know it may seem like a small sample but for our purpose is fine. - Mario 
...
registered users and anonymous volunteers. Registered users were responsible of around
...
presented. There were only 18 registered users, and the exact number of anonymous
