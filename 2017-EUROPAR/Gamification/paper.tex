...
the theory of Evolution and its molecular basis. The fact that they are population-based makes them suitable for a straightforward distribution of work to different clients, and since they have an asynchronous nature, there is no impact on their performance. All these properties make them ideal candidates for volunteer computing setups such as the one presented in this paper.


There are several open issues in the research regarding the application of volunteer computing techniques to the development of  distributed evolutionary algorithms of which the most important is approaching volunteer computing as a socio-technical system \cite{vespignani2009predicting} which integrates user decisions and behavioral patterns in the system model; this
...
robot\'s resulting actions. For interaction, they use the Twitch streaming platform where users can issue commands through the
...
The proof-of-concept efforts described above, do not go any further than to trying to find out how many users join the effort, and how many of them the system is able to support. In fact, systems such as the one described in
