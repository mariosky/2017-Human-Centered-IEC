...
In this work, a case study is presented. The development of a web based C-IEC application 
...
comparing three versions of the application, with, and with out, gamification
in order to compare the amount of user participation.
