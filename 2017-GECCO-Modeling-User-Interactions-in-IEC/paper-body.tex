...
% Volunteers 
Using a volunteer based system  
...
In evolutionary computation algorithms are data driven, as it is important to keep data about the 
...
For example, in a C-IEC application, fitness assignment depend on the actions of a social network of users. 
