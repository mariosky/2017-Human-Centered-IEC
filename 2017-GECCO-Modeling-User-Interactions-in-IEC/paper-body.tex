...
users that click on it. %Will we comment on that? - JJ
...
the availability of computing resources in several clusters, which  is in concordance with the results obtained in \cite{agajaj}, and also
...
same pattern, participation was fittted to a 
Weibull distribution,
 and shown in Figures \ref{fig:w2} and \ref{fig:w3}, confirming  this model for user interaction, although with different fitted
values in each case. 
%
\begin{figure}[!t]
    \centering
