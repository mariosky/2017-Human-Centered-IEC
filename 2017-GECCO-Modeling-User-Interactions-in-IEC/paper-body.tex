...
The framework is a reusable architectural design together with an implementation \cite{campbell1991choices}. We deliberately use the more general term Human instead of User, because humans are not always playing the role of
...
% is a reusable design together with an implementation
...
evolutionary process in a given IEC application. 
