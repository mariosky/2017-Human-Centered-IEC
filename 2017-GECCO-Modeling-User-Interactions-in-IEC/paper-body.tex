...
depending on the rating (from 1 to 5 stars) of each particular user,  % how do you define
                                % "taste"? - JJ
                                % Using actions
resulting in a many-to-many relationship between users and
phenotypes. 
 %scored by them? - JJ 
Other components or users of the systems can % formerly published methods? Other researchers? - JJ
% Corrected -Mario
...
\cite{picbreeder}.
In order to do this, metadata about phenotypes % metadata better? - JJ Yes -Mario
...
phenotypes more than compensates for that. % Added this, check it
                                % out.  
                                % Ok! - Mario (and knowing how much more is future work)
...
First, he can assign a rating % Why don't you use other
