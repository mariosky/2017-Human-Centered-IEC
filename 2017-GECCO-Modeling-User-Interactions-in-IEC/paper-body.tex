...
The ES-I % You should use always the same acronym, not start using it
         % here - JJ
...
depending on the tastes of each particular user,  % how do you define
                                % "taste"? - JJ
resulting in a many-to-many relationship between users and
phenotypes. %scored by them? - JJ 
Many systems % formerly published methods? Other researchers? - JJ
...
\cite{picbreeder}.
In order to do this, data about phenotypes % metadata better? - JJ
...
phenotypes more than compensates for that. % Added this, check it
                                % out. 
...
First, he can assign a quality assessment % Why don't you use other
                                % thing instead of quality? We are not
                                % talking about quality, but about
                                % tastes or similar - JJ
